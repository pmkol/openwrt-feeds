...
define Package/default-settings
  ...
  PKGARCH:=all
  DEPENDS:=+luci-base +luci-compat +luci-lib-ipkg +luci-proto-ipv6 +kmod-tun +kmod-nf-nathelper-extra +6in4 +odhcp6c +odhcpd-ipv6only +openssl-util +@LUCI_LANG_zh_Hans
endef
